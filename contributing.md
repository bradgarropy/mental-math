...
```bash
git clone https://github.com/<username>/mental-math
```
...
<table>
  <tr>
    <td align="center"><a href="https://bradgarropy.com"><img src="https://avatars.githubusercontent.com/u/11336745?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Brad Garropy</b></sub></a><br /><a href="https://github.com/bradgarropy/mental-math/commits?author=bradgarropy" title="Code">💻</a> <a href="#design-bradgarropy" title="Design">🎨</a> <a href="https://github.com/bradgarropy/mental-math/commits?author=bradgarropy" title="Documentation">📖</a> <a href="#infra-bradgarropy" title="Infrastructure (Hosting, Build-Tools, etc)">🚇</a> <a href="https://github.com/bradgarropy/mental-math/commits?author=bradgarropy" title="Tests">⚠️</a></td>
  </tr>
</table>
...
[issues]: https://github.com/bradgarropy/mental-math/issues
[codesandbox]: https://codesandbox.io
[kcd-pr]: https://egghead.io/courses/how-to-contribute-to-an-open-source-project-on-github
[license]: https://github.com/bradgarropy/mental-math/blob/master/license
[fork]: https://github.com/bradgarropy/mental-math/fork
[contributors]: https://github.com/bradgarropy/mental-math#-contributors
